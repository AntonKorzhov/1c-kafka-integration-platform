...
- PostgreSQL 18 с PK, FK и `INSERT ... ON CONFLICT DO UPDATE`;
...
```text
1c/                    Инструкция, export и screenshots
...
```
<details>
<summary>Результат полной синхронизации</summary>
<img width="1823" height="117" alt="image" src="https://github.com/user-attachments/assets/9aa41431-661b-4c2f-9db3-c9d7c0a857dc" />
</details>
...
<details>
<summary>Результат инкрементальной синхронизации</summary>
<img width="1815" height="108" alt="image" src="https://github.com/user-attachments/assets/ee8b699f-6c43-4159-8e44-46b1c292e3df" />
</details>
...
<details>
  <summary>Скриншоты графического интерфейса Kafka UI</summary>

  ### Топики
  <img width="2559" height="624" alt="image" src="https://github.com/user-attachments/assets/70f69ce6-7287-4560-8330-8fee1a972aea" />

  ### Просмотр событий

  <img width="2559" height="1261" alt="image" src="https://github.com/user-attachments/assets/eeefe39c-a6e4-4693-b1c1-27d736646fcc" />
</details>
...
<details>
  <summary>Скриншоты графического интерфейса Grafana</summary>

  ### Dashboards
  <img width="2559" height="613" alt="image" src="https://github.com/user-attachments/assets/35f4de2f-7589-48d4-a588-4ce82d22e184" />

  ### Просмотр всех логов сервисов

  <img width="2559" height="1456" alt="image" src="https://github.com/user-attachments/assets/0b8d75a0-01ae-40b2-a0bc-4ed82886feaa" />

  ### Просмотр логов конкретного сервиса

  <img width="2559" height="1053" alt="image" src="https://github.com/user-attachments/assets/c7a852a8-0595-4c65-ae12-43393b1477e0" />

  ### Подробный просмотр логов через Drilldown

  <img width="2559" height="1460" alt="image" src="https://github.com/user-attachments/assets/b22bc00d-61f3-4aac-8c65-4dd9697214df" />
...
- поддерживается синхронизация только двух справочников: форм собственности и контрагентов;
- интеграция с 1С выполняется через HTTP-сервис и использует механизм инкрементальной синхронизации на основе поля `updated_at`;
- инфраструктура рассчитана на локальный запуск через Docker Compose и использует один Kafka broker;
- схема сообщений Kafka задаётся приложением и не использует Schema Registry.
